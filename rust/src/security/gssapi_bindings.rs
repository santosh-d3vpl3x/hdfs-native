...
const _: () = {
    ...
    ["Offset of field: gss_OID_desc_struct::length"]
        [offset_of!(gss_OID_desc_struct, length) - 0usize];
    ["Offset of field: gss_OID_desc_struct::elements"]
        [offset_of!(gss_OID_desc_struct, elements) - 8usize];
};
...
const _: () = {
    ...
    ["Offset of field: gss_OID_set_desc_struct::count"]
        [offset_of!(gss_OID_set_desc_struct, count) - 0usize];
    ["Offset of field: gss_OID_set_desc_struct::elements"]
        [offset_of!(gss_OID_set_desc_struct, elements) - 8usize];
};
...
const _: () = {
    ...
    ["Offset of field: gss_buffer_desc_struct::length"]
        [offset_of!(gss_buffer_desc_struct, length) - 0usize];
    ["Offset of field: gss_buffer_desc_struct::value"]
        [offset_of!(gss_buffer_desc_struct, value) - 8usize];
};
...
const _: () = {
    ...
    ["Offset of field: gss_channel_bindings_struct::initiator_addrtype"]
        [offset_of!(gss_channel_bindings_struct, initiator_addrtype) - 0usize];
    ["Offset of field: gss_channel_bindings_struct::initiator_address"]
        [offset_of!(gss_channel_bindings_struct, initiator_address) - 8usize];
    ["Offset of field: gss_channel_bindings_struct::acceptor_addrtype"]
        [offset_of!(gss_channel_bindings_struct, acceptor_addrtype) - 24usize];
    ["Offset of field: gss_channel_bindings_struct::acceptor_address"]
        [offset_of!(gss_channel_bindings_struct, acceptor_address) - 32usize];
    ["Offset of field: gss_channel_bindings_struct::application_data"]
        [offset_of!(gss_channel_bindings_struct, application_data) - 48usize];
};
...
const _: () = {
    ...
    ["Offset of field: gss_krb5_lucid_key::type_"]
        [offset_of!(gss_krb5_lucid_key, type_) - 0usize];
    ["Offset of field: gss_krb5_lucid_key::length"]
        [offset_of!(gss_krb5_lucid_key, length) - 4usize];
    ["Offset of field: gss_krb5_lucid_key::data"]
        [offset_of!(gss_krb5_lucid_key, data) - 8usize];
};
...
const _: () = {
    ...
    ["Offset of field: gss_krb5_rfc1964_keydata::sign_alg"]
        [offset_of!(gss_krb5_rfc1964_keydata, sign_alg) - 0usize];
    ["Offset of field: gss_krb5_rfc1964_keydata::seal_alg"]
        [offset_of!(gss_krb5_rfc1964_keydata, seal_alg) - 4usize];
    ["Offset of field: gss_krb5_rfc1964_keydata::ctx_key"]
        [offset_of!(gss_krb5_rfc1964_keydata, ctx_key) - 8usize];
};
...
const _: () = {
    ...
    ["Offset of field: gss_krb5_cfx_keydata::have_acceptor_subkey"]
        [offset_of!(gss_krb5_cfx_keydata, have_acceptor_subkey) - 0usize];
    ["Offset of field: gss_krb5_cfx_keydata::ctx_key"]
        [offset_of!(gss_krb5_cfx_keydata, ctx_key) - 8usize];
    ["Offset of field: gss_krb5_cfx_keydata::acceptor_subkey"]
        [offset_of!(gss_krb5_cfx_keydata, acceptor_subkey) - 24usize];
};
...
const _: () = {
    ...
    ["Offset of field: gss_krb5_lucid_context_v1::version"]
        [offset_of!(gss_krb5_lucid_context_v1, version) - 0usize];
    ["Offset of field: gss_krb5_lucid_context_v1::initiate"]
        [offset_of!(gss_krb5_lucid_context_v1, initiate) - 4usize];
    ["Offset of field: gss_krb5_lucid_context_v1::endtime"]
        [offset_of!(gss_krb5_lucid_context_v1, endtime) - 8usize];
    ["Offset of field: gss_krb5_lucid_context_v1::send_seq"]
        [offset_of!(gss_krb5_lucid_context_v1, send_seq) - 16usize];
    ["Offset of field: gss_krb5_lucid_context_v1::recv_seq"]
        [offset_of!(gss_krb5_lucid_context_v1, recv_seq) - 24usize];
    ["Offset of field: gss_krb5_lucid_context_v1::protocol"]
        [offset_of!(gss_krb5_lucid_context_v1, protocol) - 32usize];
    ["Offset of field: gss_krb5_lucid_context_v1::rfc1964_kd"]
        [offset_of!(gss_krb5_lucid_context_v1, rfc1964_kd) - 40usize];
    ["Offset of field: gss_krb5_lucid_context_v1::cfx_kd"]
        [offset_of!(gss_krb5_lucid_context_v1, cfx_kd) - 64usize];
};
...
const _: () = {
    ...
    ["Offset of field: gss_krb5_lucid_context_version::version"]
        [offset_of!(gss_krb5_lucid_context_version, version) - 0usize];
};
